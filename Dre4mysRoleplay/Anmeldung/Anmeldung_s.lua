...
addEvent('Dre4mYRegistrieren',true)
addEventHandler('Dre4mYRegistrieren',root,selfmadeRegistrieren)
...
addEvent('Dre4mYEinloggen',true)
addEventHandler('Dre4mYEinloggen',root,selfmadeEinloggen)
