...
local kameraTexte = {
[1] = "Herzlich willkommen auf Dre4mY's Roleplay! In diesem kleinen Intro werden dir nun die wichtigsten Orte gezeigt.",
...
[1] = "Welcome on Dre4mY's Roleplay! In this little Intro we will show you the most important positions.",
...
function introDxDraw()
	dxDrawRectangle(6*(x/1440), 510*(y/900), 1434*(x/1440), 126*(y/900), tocolor(0, 0, 0, 200), false)
